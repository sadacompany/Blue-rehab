...
function StudentDashboard() {
  return <>
    <div className="metrics-grid"><Metric label="الدورة الحالية" value="تأهيل إصابات الركبة" note="نموذج دورة من Supabase" icon={BookOpenCheck} /><Metric label="التقدم" value="2 من 6 وحدات" note="مثال لاحتساب الإنجاز" icon={Activity} /><Metric label="المحاضرة القادمة" value="الخميس، 7:00 م" note="موعد توضيحي" icon={CalendarDays} /></div>
