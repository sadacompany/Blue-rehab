# روابط الجلسات عن بُعد

> **الوضع الحالي: `MEETING_PROVIDER=jitsi` — يعمل الآن دون أي مفاتيح.**
>
> يُشتق رابط الغرفة من رقم الحجز مباشرة، فلا يوجد ما يُنشأ ولا حساب يُربط ولا سر
> يُدار. النطاق الافتراضي `8x8.vc` (تشغّله 8x8 المطوّرة لـ Jitsi)، ويُضبط عبر
> `MEETING_JITSI_DOMAIN`.
>
> تم التحقق ميدانيًا في 2026-08-05:
>
> | النطاق | يسمح ببدء الاجتماع دون تسجيل دخول |
> |---|---|
> | `8x8.vc` | ✅ الاسم فقط — **الافتراضي** |
> | `meet.ffmuc.net` | ✅ لكنه خادم مجتمعي تطوّعي |
> | `meet.jit.si` | ❌ يطلب تسجيل دخول مشرف (Google/GitHub/Facebook) |
>
> **قبل التعامل مع بيانات مرضى حقيقية:** الخوادم العامة مشتركة ولا تقدّم ضمان
> خدمة. استضف Jitsi على خادم خاص وغيّر `MEETING_JITSI_DOMAIN` — لا يتطلب ذلك أي
> تعديل في الكود.

---

## البديل: Google Meet (`MEETING_PROVIDER=google`)

يميّزه أن المريض يعرف الاسم، وأن الدعوة تصل بالبريد تلقائيًا من التقويم. مقابل
ذلك يحتاج حساب Google واحدًا وربطًا لمرة واحدة كما هو موضّح أدناه.
